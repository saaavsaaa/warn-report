package cn.tellwhy.service.impl;

import com.alibaba.rocketmq.client.consumer.DefaultMQPushConsumer;
import com.alibaba.rocketmq.client.consumer.listener.MessageListenerConcurrently;
import com.alibaba.rocketmq.client.exception.MQClientException;
import com.alibaba.rocketmq.common.consumer.ConsumeFromWhere;
import cn.tellwhy.third.rocketDoubleWrite.listener.MessageReceive;
import cn.tellwhy.third.rocketDoubleWrite.listener.RocketListener;
import cn.tellwhy.third.rocketDoubleWrite.listener.impl.BusinessRun;
import cn.tellwhy.service.PushConsumerService;
...
public class PushConsumerServiceImpl implements PushConsumerService {
    ...
    public PushConsumerServiceImpl(){
        ResourceBundle bundle = ResourceBundle.getBundle("cn/tellwhy/third/rocket");
