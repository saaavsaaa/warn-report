...
public class UtilBase64Trace {
    ...
    @OnMethod(clazz = "com.caijinquan.p2p.common.bos.reapel.client.utils.Base64", method = "decodeBase64")
    public static void startMethod(){
        startTime = timeMillis();
    }
    
    @OnMethod(clazz = "com.caijinquan.p2p.common.bos.reapel.client.utils.Base64", method = "decodeBase64", location = @Location(Kind.RETURN))
    ...
    @OnMethod(clazz = "com.caijinquan.p2p.common.bos.reapel.client.utils.Base64", method = "decodeBase64", location = @Location(Kind.ERROR))
