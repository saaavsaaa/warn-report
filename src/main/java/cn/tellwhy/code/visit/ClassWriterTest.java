...
public class ClassWriterTest {
    ...
    */
    public static void main(String[] args){
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_ABSTRACT + ACC_INTERFACE, "cn/tellwhy/code/visit/VisitTest", null, "java/lang/Object", new String[] {"cn/tellwhy/code/record/ClearedCode"});
        ...
        */
        cw.visitMethod(ACC_PUBLIC + ACC_ABSTRACT, "cn/tellwhy/run", "(Ljava/lang/Object;)I", null, null).visitEnd();
    ...
    private static void print(){
        ...
        cv.visit(V1_5, ACC_PUBLIC, "cn/tellwhy/third/rocketDoubleWrite/ProducerDouble", null, "java/lang/Object", new String[] {"cn/tellwhy/third/rocketDoubleWrite/IProducer"});
        ...
        cv.visitMethod(ACC_PUBLIC, "cn/tellwhy/run", "(Ljava/lang/Object;)I", null, null).visitEnd();
        cv.visitEnd();
